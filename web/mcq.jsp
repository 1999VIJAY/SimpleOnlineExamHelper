...
<html>
    ...
    <body style="background-image: url(image/signup_background.gif);">
        ...
        <div class="topnav" id="myTopnav">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <a  class="active" href="mcq.jsp"><i class="fa fa-fw fa-search"></i> MCQ Test</a>
        ...
        <div class="container-fluid text-center">
          ...
          <!--  <div class="row"><div class="col"><h1 style="color: wheat">IEA Objective Type  Previous Year Questions :</h1><br></div></div>
            <div class="row">
                <div class="col"><a href="iea2018.jsp"><img src="image/iea_logo.jpg" class="rounded" alt="iea18" width="300" height="300"><br><p style=" color: yellow">IEA 2018</p></a></div>

                <div class="col"><a href="iea2017.jsp"><img src="image/iea_logo.jpg" class="rounded" alt="iea17" width="300" height="300"><br><p style=" color: yellow">IEA 2017</p></a></div>
                <div class="col"><a href="iea2016.jsp"><img src="image/iea_logo.jpg" class="rounded" alt="iea16" width="300" height="300"><br><p style=" color: yellow">IEA 2016</p></a></div>
            </div>-->
          <div class="row"><div class="col"><h1 style="color: wheat"><u>PPL Objective Type  Previous Year Questions :</u></h1><br></div></div>
            ...
            <div class="row">
                ...
                <div class="col"><a href="wadd2017.jsp"><img src="image/wadd17.png" class="rounded" alt="wadd17" width="300" height="300"><br><p style=" color: yellow">WADD 2017</p></a></div>
                <div class="col"><a href="wadd2016.jsp"><img src="image/wadd16.png" class="rounded" alt="wadd16" width="300" height="300"><br><p style=" color: yellow">WADD 2016</p></a></div>
            </div><hr>
            <div class="row"><div class="col"><h1 style="color: wheat"><u>CD Objective Type  Previous Year Questions :</u></h1><br></div></div>
            <div class="row">
                <div class="col"><a href="cd2018.jsp"><img src="image/cd18.png" class="rounded" alt="cd18" width="300" height="300"><br><p style=" color: yellow">CD 2018</p></a></div>

                <div class="col"><a href="cd2017.jsp"><img src="image/cd17.png" class="rounded" alt="cd17" width="300" height="300"><br><p style=" color: yellow">CD 2017</p></a></div>
