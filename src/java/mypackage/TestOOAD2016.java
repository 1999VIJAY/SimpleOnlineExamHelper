...
import static mypackage.TestOOAD2016.con;
import static mypackage.TestOOAD2016.psmt;
import static mypackage.TestOOAD2016.rs;


public class TestOOAD2016 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            psmt = con.prepareStatement("SELECT * FROM mcq where sub='OOAD' and year='2016'");
           ...
           /* out.println("<br>user_answer:"+uans+"<br>");
            ...
            out.print(
                    ...
                    + "<body  style=\"background:radial-gradient(#958548, #7de7a7)\">"
                            + "<center>"
                            + "<div style=color:blue><h1>Hi,&nbsp;&nbsp;" + session.getAttribute("uname")+"<br>Your Test Result<br>of<br>OOAD 2016 Objectives<br></h1> </div>"
                    ...
                    + "<div><h3><br><hr></h3></div>"
                            + "<div style=color:yellow><h1>***Test Summary***<br>of<br>***OOAD 2016***</h1></div>"
                    + "<table border=2>"
                    + "<tr>"
                    ...
                    + "<td><center><div style=color:darkgreen><h2>" + correct_answer.get(8) + "</h2></div></center></td>"
                    + "</tr>"
                    + "<tr>"
