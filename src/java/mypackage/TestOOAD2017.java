...
import static mypackage.TestOOAD2017.con;
import static mypackage.TestOOAD2017.psmt;
import static mypackage.TestOOAD2017.rs;


public class TestOOAD2017 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            psmt = con.prepareStatement("SELECT * FROM mcq where sub='OOAD' and year='2017'");
          ...
          /*  out.println("<br>user_answer:"+uans+"<br>");
            ...
            out.print(
                    ...
                    + "<div><h3><br><hr></h3></div>"
                            + "<div style=color:yellow><h1>***Test Summary***<br>of<br>***OOAD 2017***</h1></div>"
                    + "<table border=2>"
                    + "<tr>"
